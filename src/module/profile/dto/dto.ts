...
export class UpdateMentorProfileDto {
  ...
  @ApiProperty({
    example: 'Men NestJS ustasiman.',
    description: 'O‘zim haqimda qisqacha',
  })
  about: string;

  @ApiPropertyOptional({
    example: 'https://t.me/username',
    description: 'Telegram profili',
  })
  telegram?: string;

  @ApiPropertyOptional({
    example: 'https://facebook.com/username',
    description: 'Facebook profili',
  })
  facebook?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'GitHub profili',
  })
  github?: string;

  @ApiPropertyOptional({
    example: 'https://myportfolio.com',
    description: 'Shaxsiy vebsayt',
  })
  website?: string;
}
